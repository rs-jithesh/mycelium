...
export function createDefaultState(): GameState {
  ...
  return {
    ...
    hostFlavor: 'A dry autumn remnant. Fragile. The first meal.',
    ...
    knownEnemies: [],
    enemyEncounterCounts: {},
    enemyVictoryCounts: {},
    enemyDefeatCounts: {},
    totalEnemiesDefeated: 0,
    totalEnemiesFailed: 0,
    activeEnemyDebuffs: [],
    activeEnemyCombat: null,
    nextEnemyCheckAt: now + BALANCE.PVE_ENEMY_FIRST_CHECK_MS,
