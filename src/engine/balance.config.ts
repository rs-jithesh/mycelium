...
export const BALANCE = {
  ...
  // PvE encounter cadence and resolution.
  PVE_ENEMY_FIRST_CHECK_MS: 25_000,
  PVE_ENEMY_CHECK_BASE_MS: 150_000,
  PVE_ENEMY_CHECK_MIN_MS: 70_000,
  PVE_ENEMY_CHECK_STAGE_REDUCTION_MS: 8_000,
  PVE_ENEMY_CHECK_RESILIENCE_REDUCTION_MS: 3_500,
  PVE_ENEMY_TRIGGER_BASE: 0.12,
  PVE_ENEMY_TRIGGER_PER_STAGE: 0.025,
  PVE_ENEMY_TRIGGER_COMPLEXITY_BONUS: 0.01,
  PVE_ENEMY_TRIGGER_MAX: 0.42,
  PVE_PLAYER_POWER_STAGE_BASE: 1.8,
  PVE_PLAYER_POWER_VIRULENCE: 1.15,
  PVE_PLAYER_POWER_RESILIENCE: 0.95,
  PVE_PLAYER_POWER_COMPLEXITY: 0.85,
  PVE_PLAYER_POWER_SKILL: 0.22,
  PVE_PLAYER_POWER_HOST_ECHO: 0.18,
  PVE_COUNTERMATCH_ADVANTAGE_BONUS: 0.18,
  PVE_COUNTERMATCH_RESIST_PENALTY: 0.12,
  PVE_OUTCOME_PERFECT_RATIO: 1.45,
  PVE_OUTCOME_VICTORY_RATIO: 1.0,
  PVE_OUTCOME_PYRRHIC_RATIO: 0.76,
  PVE_REWARD_PERFECT_MULT: 1.45,
  PVE_REWARD_VICTORY_MULT: 1.0,
  PVE_REWARD_PYRRHIC_MULT: 0.55,
  PVE_REWARD_DEFEAT_MULT: 0.0,
  PVE_DROP_LUCK_COMPLEXITY_BONUS: 0.015,
  PVE_DEBUFF_PYRRHIC_DURATION_MS: 75_000,
  PVE_DEBUFF_DEFEAT_DURATION_MS: 135_000,
  PVE_COMBAT_PLAYER_INTEGRITY_BASE: 24,
  PVE_COMBAT_PLAYER_INTEGRITY_RESILIENCE: 4,
  PVE_COMBAT_PLAYER_INTEGRITY_STAGE: 1.5,
  PVE_COMBAT_PLAYER_ATTACK_BASE: 2.8,
  PVE_COMBAT_PLAYER_ATTACK_VIRULENCE: 0.9,
  PVE_COMBAT_PLAYER_ATTACK_COMPLEXITY: 0.35,
  PVE_COMBAT_ENEMY_HEALTH_MULT: 4.5,
  PVE_COMBAT_ENEMY_ATTACK_MULT: 0.7,
  PVE_COMBAT_ENEMY_INTERVAL_MS: 2200,
  PVE_COMBAT_ENEMY_INTERVAL_STAGE_REDUCTION_MS: 90,
  PVE_COMBAT_ENEMY_INTERVAL_MIN_MS: 1100,
  PVE_COMBAT_WINDUP_MS: 650,
  ...
  // Countermeasure mitigation fractions (tiered system)
  COUNTERMEASURE_FULL_MITIGATION: 0.70,
  COUNTERMEASURE_PARTIAL_MITIGATION: 0.30,
  COUNTERMEASURE_NO_MITIGATION: 0.0,
  COUNTERMEASURE_RESILIENCE_BONUS_PER_POINT: 0.05,
  COUNTERMEASURE_RESILIENCE_MITIGATION_CAP: 0.90,
